        ...
        for _, row in df.iterrows():
            try:
                ...
                data = (
                    ...
                    row.get('nb_pieces', None),
                    row.get('nb_chambres', None),
                    row.get('type_habitation', None),
                    row.get('code_postal', None),
                    row.get('departement', None),
                    row.get('ville', None),
                    row.get('dpe_consumption', None),
                    row.get('dpe_rating', None),
                    row.get('ges_emission', None),
                    row.get('ges_rating', None),
                    row.get('prix_m2', None),
                    row.get('date_publication', None),
                    row.get('reference', None),
                    row.get('url', None),
                    row.get('agency_id', None)
                )
    ...
    try:
        ...
        for _, row in df.iterrows():
            try:
                ...
                data = (
                    row.get('agency_id', None),
                    row.get('agency_name', None),
                    adresse_complete,
                    code_postal,
                    ville,
                    row.get('agency_phone', None),
                    row.get('agency_siret', None),
                    row.get('agency_card_number', None),
                    row.get('agency_legal_reps', None),
                    row.get('agency_url', None),
                    row.get('date_scrape', None)
                )
